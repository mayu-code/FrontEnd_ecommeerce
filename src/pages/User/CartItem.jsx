    ...
    <div className="border-b py-4 flex flex-row justify-between">
      <Link to={`/productDetails/${item.product.id}`}>
        <div className='flex flex-row gap-4'>
          <div>
            <img src={item.product.imgUrl} alt="image" className='w-20' />
          </div>
          <div>
            ...
            <p className='capitalize font-semibold'>quantity: <span className='text-black font-semibold'>{item.quantity}</span> </p>
